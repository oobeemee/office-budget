...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 28 2026 г., 08:48
...
--
CREATE DATABASE IF NOT EXISTS `office_budget_local` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `office_budget_local`;
...
(1, 'Админ', '$2y$10$7x/Rc.WhP6Ay4G5/Z04w1uVlQVpKA5IwCRibNXJv/fFTvzk3uRJ.K', 'admin', 1, '2026-01-23 16:12:54'),
...
('root', '[{\"db\":\"office_budget_local\",\"table\":\"transaction_requests\"},{\"db\":\"office_budget_local\",\"table\":\"users\"},{\"db\":\"office_budget_local\",\"table\":\"transactions\"}]');
...
('root', '2026-01-28 06:11:42', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ru\"}');
